package com.urmilabs.shield.ui.theme

import androidx.compose.ui.graphics.Color

// Premium Deep Indigo / Sapphire palette
val md_theme_light_primary = Color(0xFF3F51B5) // Indigo 500
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFE0E0FF)
val md_theme_light_onPrimaryContainer = Color(0xFF00006E)
val md_theme_light_secondary = Color(0xFF00838F) // Cyan 800
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFB4EBF2)
...
val md_theme_dark_primaryContainer = Color(0xFF22349B)
val md_theme_dark_onPrimaryContainer = Color(0xFFE0E0FF)
val md_theme_dark_secondary = Color(0xFF4DD0E1) // Cyan 300
val md_theme_dark_onSecondary = Color(0xFF00363D)
val md_theme_dark_secondaryContainer = Color(0xFF004F58)
val md_theme_dark_onSecondaryContainer = Color(0xFFB4EBF2)
val md_theme_dark_tertiary = Color(0xFFE8C148)
...
val md_theme_dark_surface = Color(0xFF1B1B1F) // Deep space grey
...
val ShieldSafeColor = Color(0xFF4CAF50)
val ShieldWarningColor = Color(0xFFFF9800)
val ShieldDangerColor = Color(0xFFF44336)
